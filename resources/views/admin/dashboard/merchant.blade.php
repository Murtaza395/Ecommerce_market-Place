          ...
          <table class="table table-default">
            ...
            <tbody>
              <tr>
                ...
                <td class="pull-right">{{ get_formated_currency($latest_sale_total, 2, config('system_settings.currency.id')) }}</td>
              </tr>
              <tr>
                <td>{{ trans('app.refunds') }}</td>
                <td class="pull-right">-{{ get_formated_currency($latest_refund_total, 2, config('system_settings.currency.id')) }}</td>
              </tr>
              <tr>
